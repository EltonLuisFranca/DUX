<template>
  <svg v-if="icon === 'done'" viewBox="0 0 16 16" width="13" height="13">
  ...
  <svg v-else-if="icon === 'review'" viewBox="0 0 16 16" width="13" height="13">
  ...
  <svg v-else-if="icon === 'process'" viewBox="0 0 16 16" width="13" height="13">
    <circle cx="8" cy="8" r="6.4" fill="none" stroke="currentColor" stroke-width="1.4" />
